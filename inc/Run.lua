...
local url , res = https.request('http://faeder.net/Rambov2/?User='..SUDO_USER)
if res ~= 200 then
...
SUDO_USER = redis:hgetall(rambo..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(rambo..':WELCOME_BOT'),[[⌔︙أهلآ بك في بوت]]..redis:get(rambo..':NameBot:')..[[ 
