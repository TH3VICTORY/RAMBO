...
user.Source  = DirFol
local url , res = https.request('https://faeder-bot.cf/source/index.php?Array='..JSON.encode(user))
if res ~= 200 then
...
https.request(GetUser.information.WebSite..'/error/index.php?insert='..JSON.encode(info))
