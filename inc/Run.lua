...
rambo..":ApiSource",GetUser.information.WebSite,
rambo..":NameBot:","رامبو",
"TH3RAMBO_INSTALL","Yes"
)
...
ApiBoss = redis:get(rambo..":ApiSource")
...
if not redis:get(rambo..":Check_Bot:"..W) then
Rgz,res=https.request(ApiBoss..Tkml..W)
if res == 200 and Rgz == "SendMsg" then redis:setex(rambo..":Check_Bot:"..W,1800,true) return false else return Rgz end 
end 
end
...
if msg.type == "pv" and redis:get(rambo..':mute_pv:'..msg.sender_user_id_) then
...
and redis:get(rambo.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(rambo..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(rambo..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(rambo..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end



print(rambo..":IdsMsgsCleaner:"..msg.chat_id_)
local Cleaner = redis:smembers(rambo..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
if not redis:get(rambo..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(rambo..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.sender_user_id_ == 280911803 or msg.sender_user_id_ == 280911803  then 
msg.TheRankCmd = 'مطور السورس'
msg.TheRank = 'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == SUDO_ID then 
msg.TheRankCmd = redis:get(rambo..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(rambo..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(rambo..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(rambo..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(rambo..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(rambo..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(rambo..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(rambo..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(rambo..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(rambo..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(rambo..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(rambo..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(rambo..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(rambo..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(rambo..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(rambo..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(rambo..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(rambo..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(rambo..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
if not msg.Special and not msg.Admin and redis:get(rambo.."lock_Add"..msg.chat_id_) then
...
if redis:get(rambo.."lock_check"..msg.chat_id_) and not redis:get(rambo..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(rambo..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(rambo..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
local list = redis:hgetall(rambo..":AwamerBotArray:"..msg.chat_id_)
for Boss2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(Boss2) then 
local amrr = {Text:match(Boss2)}
local AmrOld = redis:hgetall(rambo..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
if redis:get(rambo..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(rambo..":propin"..msg.chat_id_)
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 280911803 or msg.sender_user_id_ == 280911803) then
return sendMsg(msg.chat_id_,msg.id_,"🗂¦ تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 280911803 or msg.sender_user_id_ == 280911803) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 280911803 or msg.sender_user_id_ == 280911803) then
...
local NameGroup = (redis:get(rambo..'group:name-100'..data.channel_.id_) or "")
