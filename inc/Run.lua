...
local url , res = https.request('http://ibcorp.ibuser.xyz/Rambov2/?User='..SUDO_USER)
if res ~= 200 then
...
download_file('https://raw.githubusercontent.com/RamboCli/RAMBO/master/run','./run')
	download_file('https://raw.githubusercontent.com/RamboCli/RAMBO/master/inc/Run.lua','./inc/Run.lua')
	download_file('https://raw.githubusercontent.com/RamboCli/RAMBO/master/inc/Script.lua','./inc/Script.lua')
	download_file('https://raw.githubusercontent.com/RamboCli/RAMBO/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/RamboCli/RAMBO/master/inc/locks.lua','./inc/locks.lua')
