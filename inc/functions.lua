...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(rambo..":NameBot:") or "رامبو"
...
local Fshar_Word , res = https.request('https://api.th3rambo.com/Words_Fshars.txt')
...
Fshar_Word , res = https.request('https://api.th3rambo.com/Words_Fshars.txt')
if res ~= 200 then Fshar_Word = "\n" end
...
var = redis:get(rambo..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(rambo..':SUDO_BOT:',UserID) then
var = redis:get(rambo..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(rambo..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(rambo..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(rambo..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(rambo..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(rambo..'owners:'..ChatID,UserID) then
var = redis:get(rambo..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(rambo..'admins:'..ChatID,UserID) then
var = redis:get(rambo..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(rambo..'whitelist:'..ChatID,UserID) then
var = redis:get(rambo..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(rambo..':NameBot:'))
...
if msg.edited then
redis:incr(rambo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(rambo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(rambo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(rambo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(rambo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(rambo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(rambo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(rambo..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(rambo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(rambo..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(rambo..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(rambo..'owners:'..msg.chat_id_)
local Admins = redis:smembers(rambo..'admins:'..msg.chat_id_)
local mmez = redis:smembers(rambo..'whitelist:'..msg.chat_id_)
...
message = message ..i.. '-l ['..info.username..'](t.me/rambo_syr) \n'
end
...
local list = redis:smembers(rambo..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(rambo..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(rambo..'username:'..v)
local count = redis:scard(rambo..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.."-l ["..info.username..'] » (`' ..v.. '`){'..count..'} \n'
else
message = message ..k.. '-l ['..info.username..'](t.me/rambo_syr) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/rambo_syr) l » (`' ..v.. '`) \n'
end
end
end
...
local list = redis:smembers(rambo..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(rambo..'admins:'..msg.chat_id_)
...
local list = redis:smembers(rambo..'whitelist:'..msg.chat_id_)
...
if redis:sismember(rambo..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(rambo..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(rambo..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(rambo..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(rambo..'gban_users')
...
local list = redis:smembers(rambo..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(rambo..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(rambo..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(rambo..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(rambo..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(rambo..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(rambo..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..rambo..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(rambo..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(rambo..'group:name'..GroupS) or '')
...
local admins = redis:smembers(rambo..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(rambo..'username:'..value)
if info then 
...
local creator = redis:smembers(rambo..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(rambo..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(rambo..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(rambo..'group:name'..v)
if info then 
...
redis:del(
rambo..'group:add'..id_group,
rambo..'lock_link'..id_group, 
rambo..'lock_id'..id_group,
rambo..'lock_spam'..id_group, 
rambo..'lock_webpage'..id_group,
rambo..'lock_markdown'..id_group,
rambo..'lock_flood'..id_group,
rambo..'lock_bots'..id_group,
rambo..'mute_forward'..id_group,
rambo..'mute_contact'..id_group,
rambo..'mute_location'..id_group,
rambo..'mute_document'..id_group,
rambo..'mute_keyboard'..id_group,
rambo..'mute_game'..id_group,
rambo..'mute_inline'..id_group,
rambo..'lock_username'..id_group,
rambo..'num_msg_max'..id_group,
rambo..'mute_text'..id_group,
rambo..'admins:'..id_group,
rambo..':Filter_Word:'..id_group,
rambo..'banned:'..id_group,
rambo..'is_silent_users:'..id_group,
rambo..'whitelist:'..id_group,
rambo..':MONSHA_BOT:'..id_group,
rambo..'owners:'..id_group,
rambo..'replay'..id_group,
rambo..':MONSHA_Group:'..id_group
)
redis:srem(rambo..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(rambo..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(rambo..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(rambo..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(rambo..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'📮¦ بواسطه ⋙「 '..NameUser..' 」 \n📬¦ المجموعه بالتأكيد ✓️ تم تفعيلها \n✓️') end
...
local GroupUsers = tonumber(redis:get(rambo..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(rambo..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(rambo..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
rambo..'group:add'..arg.chat_id_,true,
rambo..'lock_link'..arg.chat_id_,true, 
rambo..'lock_id'..arg.chat_id_,true,
rambo..'lock_spam'..arg.chat_id_,true,
rambo..'lock_webpage'..arg.chat_id_,true,
rambo..'lock_markdown'..arg.chat_id_,true,
rambo..'lock_flood'..arg.chat_id_,true,
rambo..'lock_bots'..arg.chat_id_,true,
rambo..'mute_forward'..arg.chat_id_,true,
rambo..'mute_contact'..arg.chat_id_,true,
rambo..'mute_location'..arg.chat_id_,true,
rambo..'mute_document'..arg.chat_id_,true,
rambo..'mute_keyboard'..arg.chat_id_,true,
rambo..'mute_game'..arg.chat_id_,true,
rambo..'mute_inline'..arg.chat_id_,true,
rambo..'lock_username'..arg.chat_id_,true,
rambo..'num_msg_max'..arg.chat_id_,5, 
rambo..'lock_edit'..arg.chat_id_,true,
rambo..'replay'..arg.chat_id_,true,
rambo..'lock_rdodSource'..arg.chat_id_,true,
rambo.."lock_KickBan"..msg.chat_id_,true,
rambo.."lock_mmno3"..msg.chat_id_,true,
rambo.."lock_KickBan"..msg.chat_id_,true,
rambo.."lock_RandomRdod"..msg.chat_id_,true,
rambo.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(rambo..'group:ids',arg.chat_id_) 
redis:sadd(rambo..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(rambo..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(rambo..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:hset(rambo..'username:'..UserID, 'username', Resolv)
redis:sadd(rambo..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم تقييده بنجاح \n✓")
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(rambo..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده بنجاح \n✓")
end
if cmd == "setwhitelist" then
if redis:sismember(rambo..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه \n✓") 
end
redis:hset(rambo..'username:'..UserID, 'username', Resolv)
redis:sadd(rambo..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه \n✓") 
end
if cmd == "remwhitelist" then
if not redis:sismember(rambo..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
end
redis:srem(rambo..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مميز  في المجموعه \n✓") 
end
if cmd == "setmnsha" then
if redis:sismember(rambo..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه \n✓") 
end
redis:hset(rambo..'username:'..UserID, 'username', Resolv)
redis:sadd(rambo..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ  في المجموعه \n✓") 
end
if cmd == "remmnsha" then
if not redis:sismember(rambo..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
end
redis:srem(rambo..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشى  في المجموعه \n✓") 
end

if cmd == "setowner" then
if redis:sismember(rambo..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(rambo..'username:'..UserID, 'username', Resolv)
redis:sadd(rambo..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مدير  في المجموعه \n✓") 
end
if cmd == "remowner" then
if not redis:sismember(rambo..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
end
redis:srem(rambo..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه \n✓") 
end
if cmd == "promote" then
if redis:sismember(rambo..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(rambo..'username:'..UserID, 'username', Resolv)
redis:sadd(rambo..'admins:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه ادمن  في المجموعه \n✓") 
end
if cmd == "demote" then
if not redis:sismember(rambo..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
end
redis:srem(rambo..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(rambo..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه \n✓") 
end
redis:hset(rambo..'username:'..UserID,'username',USERNAME)
redis:sadd(rambo..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(rambo..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
end
redis:srem(rambo..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(rambo..'username:'..UserID, 'username', Resolv)
redis:sadd(rambo..'banned:'..ChatID,UserID)
...
redis:hset(rambo..'username:'..UserID, 'username', Resolv)
redis:srem(rambo..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(rambo..'username:'..UserID, 'username', Resolv)
redis:sadd(rambo..'is_silent_users:'..ChatID,UserID)
...
redis:hset(rambo..'username:'..UserID, 'username', Resolv)
redis:srem(rambo..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه \n✓") 
end

if cmd == "upMshrf" then
redis:hset(rambo..'username:'..UserID,'username',Resolv)
redis:setex(rambo..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(rambo..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
local edited = redis:get(rambo..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(rambo..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
if UserID == 280911803 or UserID == 280911803 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
.."\n📝¦ التعديل » "..(redis:get(rambo..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(rambo..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(rambo..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(rambo..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(rambo..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(rambo..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(rambo..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(rambo..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(rambo..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(rambo..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(rambo..'num_msg_max'..msg.chat_id_) or 'false')
.."\n⏰¦ وقت التنظيف » "..(redis:get(rambo..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(rambo..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(rambo..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(rambo..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(rambo..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(rambo..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(rambo..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(rambo..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(rambo..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(rambo..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(rambo..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(rambo..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(rambo..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(rambo..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(rambo..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(rambo..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(rambo..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(rambo..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(rambo..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(rambo..'welcome:get'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود » "..(redis:get(rambo..'replay'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود العشوائيه » "..(redis:get(rambo.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(rambo..'lock_woring'..msg.chat_id_) or 'false')
.."\n*📝¦* الايدي » "..(redis:get(rambo..'lock_id'..msg.chat_id_) or 'false')
.."\n*💬¦* الرابط » "..(redis:get(rambo..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*📮¦* المغادره » "..(redis:get(rambo..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🗳¦* الحظر » "..(redis:get(rambo..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🔍¦* الحمايه » "..(redis:get(rambo..'antiedit'..msg.chat_id_) or 'false')
.."\n*📋¦* التاك للكل » "..(redis:get(rambo..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*📒¦* الايدي بالصوره » "..(redis:get(rambo..'idphoto'..msg.chat_id_) or 'false')
.."\n*🔐¦* التحقق » "..(redis:get(rambo.."lock_check"..msg.chat_id_) or 'false')
.."\n*🗑¦* التنظيف التلقائي » "..(redis:get(rambo.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*📂¦* ردود السورس » "..(redis:get(rambo.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(rambo..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(rambo..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(rambo..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(rambo..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(rambo..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(rambo..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(rambo..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(rambo..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(rambo..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
