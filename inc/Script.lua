...
if msg.Director 
and (redis:get(rambo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(rambo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(rambo..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(rambo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" then 
return false end 
...
if not redis:get(rambo..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'📮¦ بواسطه ⋙「 '..NameUser..' 」 \n📬¦ المجموعه بالتأكيد ✓️ تم تعطيلها \n✓️') end  
...
if redis:get(rambo..'lock_id'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)

local msgs = redis:get(rambo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local edited = (redis:get(rambo..':edited:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)
...
..'📋¦ رسائلك •⊱ {'..arg.msgs..'} ⊰•\n➖'
local Kleshaidinfo = redis:get(rambo..":infoiduser_public:"..arg.chat_id_) or redis:get(rambo..":infoiduser")  

if Kleshaidinfo then 
local points = redis:get(rambo..':User_Points:'..arg.chat_id_..arg.sender_user_id_) or 0
...
KleshaID = KleshaID:gsub("{البوت}",redis:get(rambo..':NameBot:'))
KleshaID = KleshaID:gsub("{المطور}",SUDO_USER)
end
if redis:get(rambo.."idphoto"..msg.chat_id_) then
...
local numvv = redis:get(rambo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
...
redis:setex(rambo..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_,1000,true)
redis:del(rambo..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SuperCreator  then return "📪¦ هذا الامر يخص {المنشئ الاساسي,المطور} فقط  \n" end
redis:setex(rambo..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_,1000,true)
return "- ارسل الرتبه المراد حذفها :\n\n• مطور اساسي \n• مطور \n• منشئ اساسي \n• منشئ \n• مدير \n• ادمن \n• مميز \n"
end
if MsgText[1] == "مسح قائمه الرتب" then
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
redis:del(rambo..":RtbaNew1:"..msg.chat_id_)
redis:del(rambo..":RtbaNew2:"..msg.chat_id_)
redis:del(rambo..":RtbaNew3:"..msg.chat_id_)
redis:del(rambo..":RtbaNew4:"..msg.chat_id_)
redis:del(rambo..":RtbaNew5:"..msg.chat_id_)
redis:del(rambo..":RtbaNew6:"..msg.chat_id_)
redis:del(rambo..":RtbaNew7:"..msg.chat_id_)
...
local Rtba1 = redis:get(rambo..":RtbaNew1:"..msg.chat_id_) or " لايوجد "
local Rtba2 = redis:get(rambo..":RtbaNew2:"..msg.chat_id_) or " لايوجد "
local Rtba3 = redis:get(rambo..":RtbaNew3:"..msg.chat_id_) or " لايوجد "
local Rtba4 = redis:get(rambo..":RtbaNew4:"..msg.chat_id_) or " لايوجد "
local Rtba5 = redis:get(rambo..":RtbaNew5:"..msg.chat_id_) or " لايوجد "
local Rtba6 = redis:get(rambo..":RtbaNew6:"..msg.chat_id_) or " لايوجد "
local Rtba7 = redis:get(rambo..":RtbaNew7:"..msg.chat_id_) or " لايوجد "
...
message = ""
local monsha = redis:smembers(rambo..':MONSHA_Group:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."📛| لا يوجد مالك !\n"
else
for k,v in pairs(monsha) do
local info = redis:hgetall(rambo..'username:'..v)
...
message = message..' ['..info.username..'](t.me/rambo_syr)  \n'
...
local GroupName = (redis:get(rambo..'group:name'..arg.ChatID) or '')
redis:set(rambo..'linkGroup'..arg.ChatID,(data.invite_link_ or ""))
...
if not msg.Director and redis:get(rambo..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(rambo..":MsgIDPin:"..arg.ChatID,arg.reply_id)
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not msg.Director and redis:get(rambo..'lock_pin'..msg.chat_id_) then return "لا يمكنك الغاء التثبيت الامر مقفول من قبل الاداره" end
...
elseif UserID == 280911803 or UserID == 280911803  then  
...
elseif redis:sismember(rambo..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المطور\n🛠") 
elseif redis:sismember(rambo..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(rambo..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(rambo..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(rambo..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد الادمن\n🛠") 
elseif  redis:sismember(rambo..'whitelist:'..arg.ChatID,UserID) then 
...
redis:set(rambo..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
elseif redis:sismember(rambo..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(rambo..':MONSHA_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك نقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(rambo..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(rambo..'admins:'..msg.chat_id_,UserID) then 
...
redis:del(rambo..":TqeedUser:"..arg.ChatID..UserID)
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
...
redis:del(rambo..":TqeedUser:"..arg.ChatID..arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده  من المجموعه") 
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(rambo..'whitelist:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه") 
else
redis:hset(rambo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(rambo..'whitelist:'..arg.ChatID,arg.UserID)
...
if redis:sismember(rambo..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه") 
end
redis:hset(rambo..'username:'..UserID,'username',UserName)
redis:sadd(rambo..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
NameUser = Hyper_Link_Name(data)
if not redis:sismember(rambo..'whitelist:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه") 
else
redis:srem(rambo..'whitelist:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(rambo..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه")
else
redis:srem(rambo..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(rambo..'owners:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه")
else
redis:hset(rambo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(rambo..'owners:'..arg.ChatID,UserID)
...
UserName = arg.UserName
if redis:sismember(rambo..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه")
else
redis:hset(rambo..'username:'..UserID, 'username',UserName)
redis:sadd(rambo..'owners:'..arg.ChatID,UserID)
...
if not redis:sismember(rambo..'owners:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه") 
else
redis:srem(rambo..'owners:'..arg.ChatID,arg.UserID)
...
if not redis:sismember(rambo..'owners:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه")  
else
redis:srem(rambo..'owners:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(rambo..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه") 
else
redis:hset(rambo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(rambo..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(rambo..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه") 
else
redis:hset(rambo..'username:'..UserID,'username',UserName)
redis:sadd(rambo..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(rambo..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه") 
else
redis:srem(rambo..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(rambo..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه") 
else
redis:srem(rambo..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
ReUsername = ResolveUserName(data)
NameUser   = Hyper_Link_Name(data)
if redis:sismember(rambo..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه") 
else
redis:hset(rambo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(rambo..'admins:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(rambo..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه") 
else
redis:hset(rambo..'username:'..UserID,'username',UserName)
redis:sadd(rambo..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه ادمن  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(rambo..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه") 
else
redis:srem(rambo..'admins:'..arg.ChatID,arg.UserID)
...
local UserID = data.id_
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(rambo..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه") 
else
redis:srem(rambo..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله ادمن  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
local maseegs = redis:get(rambo..'msgs:'..arg.UserID..':'..arg.ChatID) or 1
local edited = redis:get(rambo..':edited:'..arg.ChatID..':'..arg.UserID) or 0
local content = redis:get(rambo..':adduser:'..arg.ChatID..':'..arg.UserID) or 0
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(rambo..'msgs:'..UserID..':'..arg.ChatID) or 1
local edited = redis:get(rambo..':edited:'..arg.ChatID..':'..UserID) or 0
local content = redis:get(rambo..':adduser:'..arg.ChatID..':'..UserID) or 0
...
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n📛") end
GetUserID(UserID,function(arg,data)
if msg.SudoBase then redis:srem(rambo..'gban_users',arg.UserID)  end 
Restrict(arg.ChatID,arg.UserID,2)
redis:srem(rambo..'banned:'..arg.ChatID,arg.UserID)
StatusLeft(arg.ChatID,arg.UserID)
redis:srem(rambo..'is_silent_users:'..arg.ChatID,arg.UserID)
NameUser = Hyper_Link_Name(data)
...
local UserID = data.id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n📛") end
if msg.SudoBase then redis:srem(rambo..'gban_users',UserID)  end 
Restrict(arg.ChatID,UserID,2)
redis:srem(rambo..'banned:'..arg.ChatID,UserID)
StatusLeft(arg.ChatID,UserID)
redis:srem(rambo..'is_silent_users:'..arg.ChatID,UserID)
NameUser = Hyper_Link_Name(data)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم رفع القيود ان وجد  \n✓") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
if msg.SudoBase then redis:srem(rambo..'gban_users',MsgText[2])  end 
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not msg.Creator and not redis:get(rambo.."lock_KickBan"..msg.chat_id_) then return "📛*¦* الامر معطل من قبل اداره المجموعة  \n" end
...
NameUser = Hyper_Link_Name(data)
USERNAME = ResolveUserName(data)
if redis:sismember(rambo..'banned:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره  من المجموعه") 
end

redis:hset(rambo..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(rambo..'banned:'..arg.ChatID,arg.UserID)
...
if redis:sismember(rambo..'banned:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره  من المجموعه") 
end
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
redis:hset(rambo..'username:'..arg.UserID, 'username',arg.UserName)
redis:sadd(rambo..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم حظره  من المجموعه") 
...
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* عذرا هذا معرف قناة وليس حساب \n📛") end
redis:hset(rambo..'username:'..arg.UserID,'username',USERNAME)
redis:setex(rambo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,500,NameUser)
redis:setex(rambo..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,500,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* عذرا هذا معرف قناة وليس حساب \n📛") end
redis:hset(rambo..'username:'..UserID,'username',arg.USERNAME)
redis:setex(rambo..":uploadingsomeon:"..arg.ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(rambo..":uploadingsomeon2:"..arg.ChatID..msg.sender_user_id_,500,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📇¦  » حسننا الان ارسل صلاحيات المشرف :\n\n¦1- صلاحيه تغيير المعلومات\n¦2- صلاحيه حذف الرسائل\n¦3- صلاحيه دعوه مستخدمين\n¦4- صلاحيه حظر وتقيد المستخدمين \n¦5- صلاحيه تثبيت الرسائل \n¦6- صلاحيه رفع مشرفين اخرين\n\n¦[*]- لرفع كل الصلاحيات ما عدا رفع المشرفين \n¦[**] - لرفع كل الصلاحيات مع رفع المشرفين \n\n🚸¦ يمكنك اختيار الارقام معا وتعيين الكنيه للمشرف في ان واحد مثلا : \n\n¦ 136 رامبو\n📬") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,USERNAME=MsgText[2]})
...
GetChatMember(arg.ChatID,arg.UserID,function(arg,data)
if (data.status_.ID == "ChatMemberStatusKicked" or redis:sismember(rambo..'banned:'..arg.ChatID,arg.UserID)) then
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(rambo..'banned:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء حظره  من المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء حظره  من المجموعه") 
end
...
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(rambo..'is_silent_users:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد كتمه  من المجموعه") 
else
redis:hset(rambo..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(rambo..'is_silent_users:'..arg.ChatID,arg.UserID)
...
if redis:sismember(rambo..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد كتمه  من المجموعه") 
else
redis:hset(rambo..'username:'..UserID,'username',UserName)
redis:sadd(rambo..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم كتمه  من المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then 
...
if not redis:sismember(rambo..'is_silent_users:'..arg.ChatID,arg.UserID) then 
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(rambo..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء كتمه  من المجموعه") 
else
redis:srem(rambo..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه") 
...
redis:setex(rambo..'WiCmdLink'..msg.chat_id_..msg.sender_user_id_,500,true)
return '📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل  رابط مجموعتك 🍃'
end

if MsgText[1] == "انشاء رابط" then
if not msg.Creator then return "📪¦ هذا الامر يخص {المطور,المنشئ الاساسي ,المنشئ} فقط  \n" end
if not redis:get(rambo..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(rambo..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(rambo..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(rambo.."lock_linkk"..msg.chat_id_) then return "📡*¦* الامر معطل من قبل الادارة \n^"  end
if not redis:get(rambo..'linkGroup'..msg.chat_id_) then return "📡*¦* اوه 🙀 لا يوجد رابط ☹️\n🔖*¦*لانشاء رابط ارسل { انشاء رابط } \n📡" end
local GroupName = redis:get(rambo..'group:name'..msg.chat_id_)
local GroupLink = redis:get(rambo..'linkGroup'..msg.chat_id_)
return "📬¦ رابـط الـمـجـمـوعه :\n\n["..GroupLink.."]\n"
end

if MsgText[1] == "ضع القوانين" then
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(rambo..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
return '📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل القوانين  للمجموعه 🍃'
end

if MsgText[1] == "القوانين" then
if not redis:get(rambo..'rulse:msg'..msg.chat_id_) then 
return "📡*¦* مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه\n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n"
else 
return "*🔖¦القوانين :*\n"..redis:get(rambo..'rulse:msg'..msg.chat_id_) 
end 
end
...
redis:set(rambo..'num_msg_max'..msg.chat_id_,MsgText[2]) 
...
local NumLoop = tonumber(MsgText[2])
redis:set(rambo..':Timer_Cleaner:'..msg.chat_id_,NumLoop) 
...
local Admins = redis:scard(rambo..':MONSHA_Group:'..msg.chat_id_)
if Admins == 0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد منشئيين اساسييين ليتم مسحهم ✓" 
end
redis:del(rambo..':MONSHA_Group:'..msg.chat_id_)
...
if not msg.Creator then return "📪¦ هذا الامر يخص {المطور,المنشئ} فقط  \n" end
local mmezz = redis:smembers(rambo..":IdsMsgsCleaner:"..msg.chat_id_)
...
redis:del(rambo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
...
local Admins = redis:scard(rambo..'admins:'..msg.chat_id_)
if Admins == 0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ادمنيه ليتم مسحهم ✓" 
end
redis:del(rambo..'admins:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦ تم مسح {"..Admins.."} من الادمنيه في البوت \n✓"
end
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(rambo..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*¦* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(rambo..':Filter_Word:'..msg.chat_id_)
...
redis:del(rambo..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(rambo..'welcome:msg'..msg.chat_id_) then 
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(rambo..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(rambo..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "📛¦ عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(rambo..':MONSHA_BOT:'..msg.chat_id_)
...
if not msg.Creator then return "📪¦ هذا الامر يخص {المطور,المنشئ} فقط  \n" end
local NumMDER = redis:scard(rambo..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "📛¦ عذرا لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(rambo..'owners:'..msg.chat_id_)
...
local list = redis:smembers(rambo..'banned:'..msg.chat_id_)
if #list == 0 then return "*📌¦ لا يوجد مستخدمين محظورين  *" end
message = '📋*¦* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(rambo..'banned:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[1] == 'مسح المكتومين' then
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(rambo..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*¦* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(rambo..'is_silent_users:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MKTOMEN.." *} من المكتومين  \n✓"
end

if MsgText[1] == 'مسح المميزين' then
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MMEZEN = redis:scard(rambo..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*⚙️*¦ لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(rambo..'whitelist:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MMEZEN.." *} من المميزين  \n✓"
end

if MsgText[1] == 'مسح الرابط' then
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(rambo..'linkGroup'..msg.chat_id_) then 
return "*⚙️*¦ لا يوجد رابط مضاف اصلا " 
end
redis:del(rambo..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(rambo..'name:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(rambo..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(rambo..'about:witting'..msg.chat_id_..msg.sender_user_id_,300,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الوصف  للمجموعه\n🛠" 
end

if MsgText[1] == "تاك للكل" then 
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not redis:get(rambo.."lock_takkl"..msg.chat_id_) then  return "📛*¦* الامر معطل من قبل الادراة" end 
return TagAll(msg) 
end
...
if redis:sismember(rambo..':Filter_Word:'..arg.ChatID,Type_id) then 
return sendMsg(arg.ChatID,arg.MsgID,"📝*¦* هي بالتأكيد في قائمه المنع✓️")
else
redis:sadd(rambo..':Filter_Word:'..arg.ChatID,Type_id) 
...
if redis:sismember(rambo..':Filter_Word:'..arg.ChatID,Type_id) then 
redis:srem(rambo..':Filter_Word:'..arg.ChatID,Type_id) 
...
kick_user(v.user_id_,arg.ChatID,function(arg,data)  
redis:srem(rambo..':MONSHA_BOT:'..arg.ChatID,v.user_id_)
redis:srem(rambo..'whitelist:'..arg.ChatID,v.user_id_)
redis:srem(rambo..'owners:'..arg.ChatID,v.user_id_)
redis:srem(rambo..'admins:'..arg.ChatID,v.user_id_)
end)
end
NumMem = NumMem + 1
...
redis:setex(rambo..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(rambo..'CheckExpire::'..msg.chat_id_) then 
redis:set(rambo..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️¦ في مجموعه  » »  '..redis:get(rambo..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
if MsgText[2] == '1' then
redis:setex(rambo..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(rambo..'CheckExpire::'..msg.chat_id_) then 
redis:set(rambo..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم تفعيل الاشتراك   👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم تفعيل الاشتراك  👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(rambo..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(rambo..'CheckExpire::'..msg.chat_id_) then 
redis:set(rambo..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(rambo..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(rambo..'CheckExpire::'..msg.chat_id_) then 
redis:set(rambo..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
local check_time = redis:ttl(rambo..'ExpireDate:'..msg.chat_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(rambo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(rambo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(rambo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(rambo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(rambo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(rambo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(rambo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(rambo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(rambo..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
return '🧟‍♂*¦*  عدد جهہآتگ آلمـضـآفهہ‏‏ » 【'..(redis:get(rambo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..'】 . \n🐾'
end
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(rambo..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,true) 
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(rambo..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(rambo..'welcome:msg'..msg.chat_id_))
else 
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(rambo..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه") 
redis:hset(rambo..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(rambo..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if redis:sismember(rambo..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه") 
else
redis:hset(rambo..'username:'..UserID,'username',arg.UserName)
redis:sadd(rambo..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not redis:sismember(rambo..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ اساسي  في المجموعه") 
redis:srem(rambo..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
UserName = Flter_Markdown(arg.UserName)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(rambo..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه") 
else
redis:srem(rambo..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ اساسي  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
redis:del(rambo..":awamer_Klesha_m1:")
redis:del(rambo..":awamer_Klesha_m2:")
redis:del(rambo..":awamer_Klesha_m3:")
redis:del(rambo..":awamer_Klesha_mtwr:")
redis:del(rambo..":awamer_Klesha_mrd:")
redis:del(rambo..":awamer_Klesha_mf:")
redis:del(rambo..":awamer_Klesha_m:")
...
redis:del(rambo..":infoiduser_public:"..msg.chat_id_)
...
if not msg.Creator then return "📪¦ هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  \n" end
redis:setex(rambo..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
if UserID == 280911803 or UserID == 280911803 then return sendMsg(msg.chat_id_,msg.id_,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
elseif redis:sismember(rambo..'admins:'..msg.chat_id_,UserID) then 
rinkuser = 6
elseif redis:sismember(rambo..'whitelist:'..msg.chat_id_,UserID) then 
rinkuser = 7
else
rinkuser = 8
end
local DonisDown = "\n📛¦ تم تنزيله من الرتب الاتيه : \n\n "
if redis:sismember(rambo..':SUDO_BOT:',UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المطور ✓️\n"
end 
if redis:sismember(rambo..':MONSHA_Group:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المنشئ الاساسي ✓️\n"
end 
if redis:sismember(rambo..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المنشئ ✓️\n"
end 
if redis:sismember(rambo..'owners:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المدير ✓️\n"
end 
if redis:sismember(rambo..'admins:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من الادمن ✓️\n"
end 
if redis:sismember(rambo..'whitelist:'..msg.chat_id_,UserID) then
...
redis:srem(rambo..':SUDO_BOT:',UserID)
redis:srem(rambo..':MONSHA_Group:'..msg.chat_id_,UserID)
redis:srem(rambo..':MONSHA_BOT:'..msg.chat_id_,UserID)
redis:srem(rambo..'owners:'..msg.chat_id_,UserID)
redis:srem(rambo..'admins:'..msg.chat_id_,UserID)
redis:srem(rambo..'whitelist:'..msg.chat_id_,UserID)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local list = redis:hgetall(rambo..":AwamerBotArray2:"..msg.chat_id_)
local list2 = redis:hgetall(rambo..":AwamerBotArray:"..msg.chat_id_)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Awammer 	= redis:del(rambo..":AwamerBot:"..msg.chat_id_)
redis:del(rambo..":AwamerBotArray:"..msg.chat_id_)
redis:del(rambo..":AwamerBotArray2:"..msg.chat_id_)
if Awammer ~= 0 then
...
for k, Rambo in pairs(XRambo) do if MsgText[2]:match(Rambo) then  checkAmr = true end end      
if checkAmr then
redis:setex(rambo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "📭¦ حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان \n..."
else
return "📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n"
end
else
redis:setex(rambo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if MsgText[2] then
local checkk = redis:hdel(rambo..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
local AmrOld = redis:hgetall(rambo..":AwamerBotArray:"..msg.chat_id_)
amrnew = ""
amrold = ""
...
redis:hdel(rambo..":AwamerBotArray:"..msg.chat_id_,Amor)
...
redis:setex(rambo..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(rambo..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(rambo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(rambo..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مطور  في البوت") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مطور  في البوت") 
redis:hset(rambo..'username:'..arg.UserID,'username',RUSERNAME)
redis:sadd(rambo..':SUDO_BOT:',arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
redis:hset(rambo..'username:'..UserID,'username',ReUsername)
redis:sadd(rambo..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مطور  في البوت") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(rambo..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مطور  في البوت") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مطور  في البوت") 
redis:srem(rambo..':SUDO_BOT:',arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if not redis:sismember(rambo..':SUDO_BOT:',UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مطور  في البوت") 
else
redis:srem(rambo..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مطور  في البوت") 
...
local groups = redis:smembers(rambo..'group:ids')
...
local pv = redis:smembers(rambo..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(rambo..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(rambo..':WELCOME_BOT')
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(rambo..':NameBot:')..[[ 🎖
...
redis:setex(rambo..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '📭¦ حسننا عزيزي 🍁\n📋¦ الان قم بارسال الكليشه \n🛠' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(rambo..':addnumberusers',MsgText[2]) 
return '💱*¦* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*¦* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(rambo..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🔝" then 
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
return '📮*¦* عدد المجموعات المفعلة » `'..redis:scard(rambo..'group:ids')..'`  ➼' 
end
...
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(rambo.."lockidedit") then return "📛*¦* الامر معطل من قبل المطور الاساسي  \n" end
redis:del(rambo..":infoiduser")
...
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(rambo.."lockidedit") then return "📛*¦* تعيين الايدي معطل من قبل المطور الاساسي  \n" end
redis:setex(rambo..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '📮*¦* حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n قناه الكلايش : [@Change_id] \n➼' 
end
...
redis:setex(rambo..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(rambo..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(rambo..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:hset(rambo..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(rambo..'gban_users',arg.UserID)
...
if redis:sismember(rambo..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره عام  من المجموعات \n✓") 
else
redis:hset(rambo..'username:'..UserID,'username',UserName)
redis:sadd(rambo..'gban_users',UserID)
...
if GeneralBanned(arg.UserID) then 
redis:srem(rambo..'gban_users',arg.UserID)
...
if not redis:sismember(rambo..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء حظره العام  من المجموعات \n✓") 
else
redis:srem(rambo..'gban_users',UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء حظره العام  من المجموعات \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not msg.Admin then return "📪¦ هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(rambo..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,
rambo..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,
rambo..'name:witting'..msg.chat_id_..msg.sender_user_id_,
rambo..'about:witting'..msg.chat_id_..msg.sender_user_id_,
rambo..'fwd:all'..msg.sender_user_id_,
rambo..'fwd:pv'..msg.sender_user_id_,
rambo..'fwd:groups'..msg.sender_user_id_,
rambo..'namebot:witting'..msg.sender_user_id_,
rambo..'addrd_all:'..msg.sender_user_id_,
rambo..'delrd:'..msg.sender_user_id_,
rambo..'addrd:'..msg.sender_user_id_,
rambo..'delrdall:'..msg.sender_user_id_,
rambo..'text_sudo:witting'..msg.sender_user_id_,
rambo..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
rambo..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,
rambo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,
rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_,
rambo..':KStart:'..msg.chat_id_..msg.sender_user_id_,
rambo.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_,
rambo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,
rambo..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,
rambo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,
rambo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,
rambo..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,
rambo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,
rambo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
rambo..":ForceSub:"..msg.sender_user_id_,
rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,
rambo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,
rambo..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_,
rambo..'replay1Random'..msg.chat_id_..msg.sender_user_id_,
rambo..'addrdRandom1:'..msg.sender_user_id_,
rambo..'addrdRandom:'..msg.sender_user_id_,
rambo..'replay1Random'..msg.sender_user_id_)
...
return '👨🏾‍🔧¦ اصدار سورس رامبو : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://th3victory.github.io/GetVersion.txt') or "0"
GetVerison = GetVerison:gsub("\n",""):gsub(" ","")
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'🔛*¦* يوجد تحديث جديد الان \n📡*¦* جاري تنزيل وتثبيت التحديث  ...')
redis:set(rambo..":VERSION",GetVerison)
return false
else
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس رامبو يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : رامبو 🍃",url="t.me/rambo_syr"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : رامبو](t.me/rambo_syr)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 📈" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
return 'الاحصائيات : 📈 \n\n👥*¦* عدد المجموعات المفعله : '..redis:scard(rambo..'group:ids')..'\n👤*¦* عدد المشتركين في البوت : '..redis:scard(rambo..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(rambo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(rambo..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
...
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:del(rambo..':Text_Start')
return "📭¦ تم مسح كليشه الستارت "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(rambo..'replay:'..msg.chat_id_)
local photo 	= redis:exists(rambo..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(rambo..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(rambo..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(rambo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(rambo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(rambo..'replay_video:group:'..msg.chat_id_)
local file 	= redis:exists(rambo..'replay_files:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video or file then
redis:del(rambo..'replay:'..msg.chat_id_,rambo..'replay_photo:group:'..msg.chat_id_,rambo..'replay_voice:group:'..msg.chat_id_,
rambo..'replay_animation:group:'..msg.chat_id_,rambo..'replay_audio:group:'..msg.chat_id_,rambo..'replay_sticker:group:'..msg.chat_id_,rambo..'replay_video:group:'..msg.chat_id_,rambo..'replay_files:group:'..msg.chat_id_)
...
local names 	= redis:exists(rambo..'replay:all')
local photo 	= redis:exists(rambo..'replay_photo:group:')
local voice 	= redis:exists(rambo..'replay_voice:group:')
local imation 	= redis:exists(rambo..'replay_animation:group:')
local audio 	= redis:exists(rambo..'replay_audio:group:')
local sticker 	= redis:exists(rambo..'replay_sticker:group:')
local video 	= redis:exists(rambo..'replay_video:group:')
local file 	= redis:exists(rambo..'replay_files:group:')
if names or photo or voice or imation or audio or sticker or video or file then
redis:del(rambo..'replay:all',rambo..'replay_photo:group:',rambo..'replay_voice:group:',rambo..'replay_animation:group:',rambo..'replay_audio:group:',rambo..'replay_sticker:group:',rambo..'replay_video:group:',rambo..'replay_files:group:')
...
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(rambo..'delrdall:'..msg.sender_user_id_,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(rambo..'delrd:'..msg.sender_user_id_,true)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(rambo..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(rambo..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(rambo..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(rambo..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(rambo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(rambo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(rambo..'replay_video:group:'..msg.chat_id_)
local files 	= redis:hkeys(rambo..'replay_files:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(rambo..'replay:all')
local photo 	= redis:hkeys(rambo..'replay_photo:group:')
local voice 	= redis:hkeys(rambo..'replay_voice:group:')
local imation 	= redis:hkeys(rambo..'replay_animation:group:')
local audio 	= redis:hkeys(rambo..'replay_audio:group:')
local sticker 	= redis:hkeys(rambo..'replay_sticker:group:')
local video 	= redis:hkeys(rambo..'replay_video:group:')
local files 	= redis:hkeys(rambo..'replay_files:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 and #files==0 then 
return '🚸*¦* لا يوجد ردود مضافه حاليا \n❕' 
end
local ii = 1
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(rambo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:del(rambo..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(rambo..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_,300,true)
...
local AlRdod = redis:smembers(rambo..':KlmatRRandom:'..msg.chat_id_) 
if #AlRdod == 0 then return "🛑*¦* الردود العشوائيه محذوفه بالفعل\n✓" end
for k,v in pairs(AlRdod) do redis:del(rambo..':ReplayRandom:'..msg.chat_id_..":"..v) redis:del(rambo..':caption_replay:Random:'..msg.chat_id_..v) 
end
redis:del(rambo..':KlmatRRandom:'..msg.chat_id_) 
...
local incrr = redis:scard(rambo..':ReplayRandom:'..msg.chat_id_..":"..v) 
...
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
redis:setex(rambo..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:del(rambo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
redis:setex(rambo..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_,300,true)
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الرد العشوائي العام لمسحها 🍃"
end

if MsgText[1] == "مسح الردود العشوائيه العامه" then
if not msg.SudoUser then return "📪¦ هذا الامر يخص {المطور} فقط  \n" end
local AlRdod = redis:smembers(rambo..':KlmatRRandom:') 
if #AlRdod == 0 then return "🛑*¦* الردود العشوائيه محذوفه بالفعل\n✓" end
for k,v in pairs(AlRdod) do redis:del(rambo..":ReplayRandom:"..v) redis:del(rambo..':caption_replay:Random:'..v)  end
redis:del(rambo..':KlmatRRandom:') 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."  \n🛑*¦* تم مسح جميع الردود العشوائيه\n✓"
end
...
for k,v in pairs(AlRdod) do
local incrr = redis:scard(rambo..":ReplayRandom:"..v) 
message = message..k..'- ['..v..'] ⋙ •⊱ {*'..incrr..'*} ⊰• رد\n'
end
end
return message.."\n"
...
if not msg.Director then return "📪¦ هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(rambo..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭¦ حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(rambo..'namebot:witting'..msg.sender_user_id_,300,true)
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(rambo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(rambo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_)
redis:setex(rambo..":changawmer:"..msg.chat_id_..msg.sender_user_id_,900,MsgText[1])
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(rambo..":awamer_Klesha_m:")
if textD then
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(rambo..":awamer_Klesha_m1:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(rambo..":awamer_Klesha_m2:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(rambo..":awamer_Klesha_m3:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(rambo..":awamer_Klesha_mtwr:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(rambo..":awamer_Klesha_mrd:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(rambo..":awamer_Klesha_mf:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
if not redis:get(rambo.."lock_leftgroup"..msg.chat_id_) then  return "📛*¦* امر المغادره معطل من قبل اداره المجموعة  \n" end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"👨🏼‍⚕️¦ اهلا عزيزي , لقد تم طردك من المجموعه بامر منك \n🔖¦ اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n🔖¦فهذا رابط المجموعه 💯\n🌿¦"..Flter_Markdown(redis:get(rambo..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(rambo..'linkGroup'..msg.chat_id_).."]\n")
...
return [[
Welcome To Source rambo 

⌔︙[ᴏᴡɴᴇʀ](t.me/nnnnh)
⌔︙[ᴄʜᴀɴɴᴇʟ](t.me/rambo_syr)
...
if not msg.SudoBase then return "📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://th3victory.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TH3VICTORY/th3victory.github.io/master/plugins/"..FileName)
if res == 200 then
...
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
if redis:get(rambo..":UserNameChaneel") then
return "📑¦ اهلا عزيزي المطور \n🔖¦ الاشتراك بالتأكيد مفعل"
else
redis:setex(rambo..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(rambo..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"📪¦ هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(rambo..":UserNameChaneel")
if UserChaneel then
...
local msg_pv = tonumber(redis:get(rambo..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(rambo..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛¦* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(rambo..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(rambo..'users',msg.sender_user_id_)
SUDO_USER = redis:hgetall(rambo..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
SUDO_USERR = "⚖️¦ مـعرف آلمـطـور  : "..SUDO_USER
else
...
text = [[💯¦ مـرحبآ آنآ بوت آسـمـي []]..redis:get(rambo..':NameBot:')..[[] 🎖
💰¦ آختصـآصـي حمـآيهہ‏‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‏‏ وآلتگرآر وآلخ...
...
GetUserID(msg.sender_user_id_,function(arg,data)
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
text = redis:get(rambo..':Text_Start') or text
local edited = (redis:get(rambo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local points = redis:get(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
local Emsgs = redis:get(rambo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
text = text:gsub("{البوت}",redis:get(rambo..':NameBot:'))
...
local MSG_ID = (redis:get(rambo.."USER_MSG_TWASEL"..data.forward_info_.date_) or 1)
msg = arg.msg
local SendOk = false
...
if not redis:get(rambo..'lock_twasel') then
...
redis:setex(rambo.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
if public then
redis:hset(rambo..':caption_replay:Random:'..msg.klma,input,msg.content_.caption_) 
else
redis:hset(rambo..':caption_replay:Random:'..msg.chat_id_..msg.klma,input,msg.content_.caption_) 
end
end
end

--====================== Reply Random Public =====================================
if redis:get(rambo..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) and redis:get(rambo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(rambo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(rambo..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_)
redis:del(rambo..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'♻️¦ تم اضافه رد متعدد عشوائي بنجاح ✓\n⚜️¦ يمكنك ارسال (['..klma..']) لاضهار الردود العشوائيه .')
redis:del(rambo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(rambo..':ReplayRandom:'..klma) or 1
...
redis:sadd(rambo..':KlmatRRandom:',klma) 
redis:sadd(rambo..':ReplayRandom:'..klma,":Text:"..msg.text) 
...
redis:sadd(rambo..':KlmatRRandom:',klma) 
redis:sadd(rambo..':ReplayRandom:'..klma,":Photo:"..photo_id) 
...
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(rambo..':KlmatRRandom:',klma) 
redis:sadd(rambo..':ReplayRandom:'..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_) 
...
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(rambo..':KlmatRRandom:',klma) 
redis:sadd(rambo..':ReplayRandom:'..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_) 
...
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(rambo..':KlmatRRandom:',klma) 
redis:sadd(rambo..':ReplayRandom:'..klma,":Video:"..msg.content_.video_.video_.persistent_id_) 
...
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(rambo..':KlmatRRandom:',klma) 
redis:sadd(rambo..':ReplayRandom:'..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_) 
...
redis:sadd(rambo..':KlmatRRandom:',klma) 
redis:sadd(rambo..':ReplayRandom:'..klma,":Document:"..msg.content_.document_.document_.persistent_id_) 
...
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(rambo..':KlmatRRandom:',klma) 
redis:sadd(rambo..':ReplayRandom:'..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_) 
...
if redis:get(rambo..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_) and redis:get(rambo..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(rambo..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(rambo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
redis:del(rambo..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'♻️¦ تم اضافه رد متعدد عشوائي بنجاح ✓\n⚜️¦ يمكنك ارسال (['..klma..']) لاضهار الردود العشوائيه .')
redis:del(rambo..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(rambo..':ReplayRandom:'..msg.chat_id_..":"..klma) or 1
local CountRdod2 = 10 - tonumber(CountRdod)
local CountRdod = 9 - tonumber(CountRdod)
if CountRdod2 == 0 then 
redis:del(rambo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(rambo..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(rambo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Text:"..msg.text) 
return sendMsg(msg.chat_id_,msg.id_,'تم ادراج الرد باقي '..CountRdod..'\n تم ادراج الرد ارسل رد اخر او ارسل {تم} \n✓')
elseif msg.content_.ID == "MessagePhoto" then
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
...
redis:sadd(rambo..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(rambo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Photo:"..photo_id) 
CaptionInsert(msg,photo_id,false)
return sendMsg(msg.chat_id_,msg.id_,'🌃¦ تم ادراج صور للرد باقي '..CountRdod..' ✓\n🌃¦ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(rambo..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(rambo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_) 
CaptionInsert(msg,msg.content_.voice_.voice_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'🎤¦ تم ادراج البصمه للرد باقي '..CountRdod..' ✓\n🎤¦  ارسل رد اخر او ارسل {تم}')
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(rambo..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(rambo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_) 
CaptionInsert(msg,msg.content_.animation_.animation_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'🎉¦ تم ادراج المتحركه للرد باقي '..CountRdod..' ✓\n🎉¦ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(rambo..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(rambo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Video:"..msg.content_.video_.video_.persistent_id_) 
CaptionInsert(msg,msg.content_.video_.video_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'🎥¦ تم ادراج الفيديو للرد باقي '..CountRdod..' ✓\n🎥¦ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(rambo..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(rambo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_) 
CaptionInsert(msg,msg.content_.audio_.audio_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'🎧¦ تم ادراج الصوت للرد باقي '..CountRdod..' ✓\n🎧¦ ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageDocument" then
redis:sadd(rambo..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(rambo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Document:"..msg.content_.document_.document_.persistent_id_) 
CaptionInsert(msg,msg.content_.document_.document_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'📄¦ تم ادراج الملف للرد باقي '..CountRdod..' ✓\n📄¦ ارسل رد اخر او ارسل {تم} .')  
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(rambo..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(rambo..':ReplayRandom:'..msg.chat_id_..":"..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_) 
...
--====================== Reply Only Group =====================================
if redis:get(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(rambo..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(rambo..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.content_ and msg.content_.caption_ then redis:hset(rambo..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then 
redis:del(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر\n❕")
end
redis:hset(rambo..'replay:'..msg.chat_id_,klma,msg.text)
...
redis:hset(rambo..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(rambo..'replay_voice:group:'..msg.chat_id_,klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(rambo..'replay_animation:group:'..msg.chat_id_,klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(rambo..'replay_video:group:'..msg.chat_id_,klma,msg.content_.video_.video_.persistent_id_)
redis:del(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(rambo..'replay_audio:group:'..msg.chat_id_,klma,msg.content_.audio_.audio_.persistent_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageDocument" then
redis:hset(rambo..'replay_files:group:'..msg.chat_id_,klma,msg.content_.document_.document_.persistent_id_ )
redis:del(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه ملف للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الملف الاتي .')  
elseif msg.content_.ID == "MessageSticker" then
redis:hset(rambo..'replay_sticker:group:'..msg.chat_id_,klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(rambo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(rambo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.caption_ then redis:hset(rambo..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
redis:del(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر\n❕")
end
redis:hset(rambo..'replay:all',klma,msg.text)
...
redis:hset(rambo..'replay_photo:group:',klma,photo_id)
redis:del(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(rambo..'replay_voice:group:',klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(rambo..'replay_animation:group:',klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(rambo..'replay_video:group:',klma,msg.content_.video_.video_.persistent_id_)
redis:del(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(rambo..'replay_audio:group:',klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageDocument" then
redis:hset(rambo..'replay_files:group:',klma,msg.content_.document_.document_.persistent_id_ )
redis:del(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه ملف للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار ملف الاتي .')  
elseif msg.content_.ID == "MessageSticker" then
redis:hset(rambo..'replay_sticker:group:',klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.Director and (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(rambo.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(rambo.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_)
redis:set(rambo..'linkGroup'..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين الرابط بنجاح  ")
return false
end

if msg.Creator and redis:get(rambo..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(rambo..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_)
redis:set(rambo..":infoiduser_public:"..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة الايدي بنجاح \n📮¦ يمكنك تجربة الامر الان ")
return false
end

if msg.SuperCreator and redis:get(rambo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_) then 

NameUser = redis:get(rambo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
UserID = redis:get(rambo..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
if not msg.text:match("[1234567]") and not msg.text:match("[*]") and not msg.text:match("[*][*]") then
redis:del(rambo..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
redis:del(rambo..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(rambo..'admins:'..msg.chat_id_,UserID)
local trues = "✓"
local falses = "✖️"
...
if msg.Creator and redis:get(rambo..":changawmer:"..msg.chat_id_..msg.sender_user_id_) and not redis:get(rambo..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
local amr = redis:get(rambo..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
if amr == "م1" then
redis:set(rambo..":awamer_Klesha_m1:",msg.text)
elseif amr == "م2" then
redis:set(rambo..":awamer_Klesha_m2:",msg.text)
elseif amr == "م3" then
redis:set(rambo..":awamer_Klesha_m3:",msg.text)
elseif amr == "م المطور" then
redis:set(rambo..":awamer_Klesha_mtwr:",msg.text)
elseif amr == "اوامر الرد" then
redis:set(rambo..":awamer_Klesha_mrd:",msg.text)
elseif amr == "اوامر الملفات" then
redis:set(rambo..":awamer_Klesha_mf:",msg.text)
elseif amr == "الاوامر" then
redis:set(rambo..":awamer_Klesha_m:",msg.text)
end
redis:del(rambo..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة التعليمات بنجاح \n📮¦ يمكنك تجربة الامر *{"..amr.."}* ")
end


if msg.SudoUser and redis:get(rambo..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(rambo..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_)
redis:set(rambo..":infoiduser",msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة الايدي بنجاح \n📮¦ يمكنك تجربة الامر الان ")
return false
end
...
if msg.Director and redis:get(rambo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(rambo..":AwamerBotArray2:"..msg.chat_id_)
Amr = redis:get(rambo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
checknewamr = false
...
for k, Rambo in pairs(XRambo) do 
local cceck,sec = Rambo:gsub("[(]"..Amr.."[)]","("..msg.text..")")
print(cceck,sec)
if sec ~= 0 then
redis:hset(rambo..":AwamerBotArray:"..msg.chat_id_,cceck,Rambo)
redis:hset(rambo..":AwamerBotArray2:"..msg.chat_id_,msg.text,Amr)
end
end  
redis:hset(rambo..":AwamerBot:"..msg.chat_id_,msg.text,Amr)
sendMsg(msg.chat_id_,msg.id_,"📑¦ تم تغيير الامر القديم ["..Amr.."] \n🔖¦ الى الامر الجديد ["..msg.text.."]\n...")
end
redis:del(rambo..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and not redis:get(rambo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) and redis:get(rambo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(rambo..":AwamerBotArray2:"..msg.chat_id_)
local Amr = redis:get(rambo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
...
redis:del(rambo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and redis:get(rambo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) then
local checkAmr = false
for k, Rambo in pairs(XRambo) do if msg.text:match(Rambo) then checkAmr = true end end      
if checkAmr then
sendMsg(msg.chat_id_,msg.id_,"📭¦ حسننا عزيزي , لتغير امر {* "..msg.text.." *} \n¦ ارسل الامر الجديد الان \n...")
redis:setex(rambo..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,900,msg.text)
else
sendMsg(msg.chat_id_,msg.id_,"📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n")
end
redis:del(rambo..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
return false
end


if msg.SudoUser and msg.text and redis:get(rambo..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(rambo..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_)
...
if msg.SudoUser and msg.text and redis:get(rambo..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(rambo..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_)
...
redis:setex(rambo..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_,1000,msg.text)
sendMsg(msg.chat_id_,msg.id_,"- الان ارسل الرتبه الجديده")
return false
end


if msg.SudoUser and msg.text and redis:get(rambo..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_) then 


local rtbanamenew = redis:get(rambo..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_)
if rtbanamenew == "مطور اساسي" then
redis:set(rambo..":RtbaNew1:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مطور" then
redis:set(rambo..":RtbaNew2:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "منشئ اساسي" then
redis:set(rambo..":RtbaNew3:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "منشئ" then
redis:set(rambo..":RtbaNew4:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مدير" then
redis:set(rambo..":RtbaNew5:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "ادمن" then
redis:set(rambo..":RtbaNew6:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مميز" then
redis:set(rambo..":RtbaNew7:"..msg.chat_id_,msg.text)
end
...
if msg.Director and redis:get(rambo..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) then
local checkk = redis:hdel(rambo..":AwamerBotArray2:"..msg.chat_id_,msg.text)
...
redis:del(rambo..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
local checkk = redis:hdel(rambo..":AwamerBot:"..msg.chat_id_,msg.text)
if checkk ~=0 then
tiires =  "📭¦ تم مسح الامر {* "..msg.text.." *} من قائمه الاومر \n..."
else
tiires = "📪¦ هذا الامر ليس موجود ضمن الاوامر المضافه  \n"
...
if msg.SudoBase and redis:get(rambo..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_) then
...
redis:set(rambo..":SUDO_ID:",UserID)
local usero = arg.USERNAME:gsub([[\_]],"_")
redis:hset(rambo..'username:'..UserID,'username',usero)
...
redis:del(rambo..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_)
return false 
end


if redis:get(rambo..":ForceSub:"..msg.sender_user_id_) then
redis:del(rambo..":ForceSub:"..msg.sender_user_id_)
if msg.text:match("^@[%a%d_]+$") then
...
redis:set(rambo..":UserNameChaneel",msg.text)
...
if redis:get(rambo..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(rambo..'namebot:witting'..msg.sender_user_id_)
redis:set(rambo..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"📭¦ تم تغير اسم البوت  ✋🏿\n🗯¦ الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(rambo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n❕")
end
redis:hdel(rambo..'replay_photo:group:',msg.text)
redis:hdel(rambo..'replay_voice:group:',msg.text)
redis:hdel(rambo..'replay_animation:group:',msg.text)
redis:hdel(rambo..'replay_audio:group:',msg.text)
redis:hdel(rambo..'replay_sticker:group:',msg.text)
redis:hdel(rambo..'replay_video:group:',msg.text)
redis:hdel(rambo..'replay_files:group:',msg.text)
redis:setex(rambo..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] ✓\n\n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n➼")
end
end

if redis:get(rambo..':KStart:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(rambo..':KStart:'..msg.chat_id_..msg.sender_user_id_)
redis:set(rambo..':Text_Start',msg.text)
...
if redis:get(rambo..'delrdall:'..msg.sender_user_id_) then
redis:del(rambo..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(rambo..'replay:all',msg.text)
local photo =redis:hget(rambo..'replay_photo:group:',msg.text)
local voice = redis:hget(rambo..'replay_voice:group:',msg.text)
local animation = redis:hget(rambo..'replay_animation:group:',msg.text)
local audio = redis:hget(rambo..'replay_audio:group:',msg.text)
local sticker = redis:hget(rambo..'replay_sticker:group:',msg.text)
local video = redis:hget(rambo..'replay_video:group:',msg.text)
local file = redis:hget(rambo..'replay_files:group:',msg.text)
...
redis:hdel(rambo..'replay:all',msg.text)
redis:hdel(rambo..'replay_photo:group:',msg.text)
redis:hdel(rambo..'replay_voice:group:',msg.text)
redis:hdel(rambo..'replay_audio:group:',msg.text)
redis:hdel(rambo..'replay_animation:group:',msg.text)
...
if redis:get(rambo..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(rambo..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(rambo..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*¦* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(rambo..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(rambo..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) 
redis:set(rambo..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*¦* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(rambo..'rulse:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال القوانين
redis:del(rambo..'rulse:witting'..msg.chat_id_..msg.sender_user_id_) 
redis:set(rambo..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*¦* مرحبآ عزيزي\n📦¦ تم حفظ القوانين بنجاح ✓\n🔖¦ ارسل [[ القوانين ]] لعرضها \n🛑✓')
end
if redis:get(rambo..'name:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الاسم
redis:del(rambo..'name:witting'..msg.chat_id_..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(rambo..'about:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الوصف
redis:del(rambo..'about:witting'..msg.chat_id_..msg.sender_user_id_) 
...
if redis:get(rambo..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(rambo..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(rambo..'users')  
local groups = redis:smembers(rambo..'group:ids')
...
if redis:get(rambo..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(rambo..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(rambo..'users')
if #pv >= 300 then
...
if redis:get(rambo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(rambo..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(rambo..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(rambo..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'📑*¦* عدد المجموعات •⊱ { *'..#groups..'*  } ⊰•\n🗣*¦* تـم الاذاعه بالتثبيت بنجاح ✓')
end 

if redis:get(rambo..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(rambo..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(rambo..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'📑¦ اهلا عزيزي المطور \n🔖¦ جاري نشر الرساله للمجموعات ...')			
end
...
if msg.forward_info_ and redis:get(rambo..'fwd:'..msg.sender_user_id_) then
redis:del(rambo..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(rambo..'users')
local groups = redis:smembers(rambo..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(rambo..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(rambo..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(rambo..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'🚸 ¦ تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(rambo..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(rambo..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
--=============================================================================================================================
if msg.SudoUser and msg.text and redis:get(rambo..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_) then 
if not redis:get(rambo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n❕") end
redis:setex(rambo..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:setex(rambo..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_,1400,msg.text)
...
if  msg.SudoUser and msg.text and redis:get(rambo..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(rambo..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
local DelRd = redis:del(rambo..':ReplayRandom:'..msg.text) 
if DelRd == 0 then 
return sendMsg(msg.chat_id_,msg.id_,'🛑*¦* هذا الرد ليس مضاف في الردود العشوائيه 📛')
end
redis:del(rambo..':caption_replay:Random:'..msg.text) 
redis:srem(rambo..':KlmatRRandom:',msg.text) 
...
if redis:get(rambo..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(rambo..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n❕")
end
redis:setex(rambo..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:setex(rambo..'replay1Random'..msg.chat_id_..msg.sender_user_id_,1400,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جواب الرد المتعدد العام \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] \n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n\n〽️| يمكنك اضافه 10 ردود متعدد كحد اقصى  \n➼")
end
end


if redis:get(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط
if not redis:get(rambo..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n❕")
end
redis:hdel(rambo..'replay:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(rambo..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جواب الرد \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] \n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n➼")
end
end

if msg.text and redis:get(rambo..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(rambo..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_)
local DelRd = redis:del(rambo..':ReplayRandom:'..msg.chat_id_..":"..msg.text) 
if DelRd == 0 then 
return sendMsg(msg.chat_id_,msg.id_,'🛑*¦* هذا الرد ليس مضاف في الردود العشوائيه 📛')
end
redis:del(rambo..':caption_replay:Random:'..msg.chat_id_..msg.text) 
redis:srem(rambo..':KlmatRRandom:'..msg.chat_id_,msg.text) 
return sendMsg(msg.chat_id_,msg.id_,'🛑*¦* تم حذف الرد بنجاح \n✓')
end

if redis:get(rambo..'delrd:'..msg.sender_user_id_) then
redis:del(rambo..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(rambo..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(rambo..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(rambo..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(rambo..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(rambo..'replay_audio:group:'..msg.chat_id_,msg.text)
local files 	= redis:hget(rambo..'replay_files:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(rambo..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(rambo..'replay_video:group:'..msg.chat_id_,msg.text)
...
redis:hdel(rambo..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_files:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_video:group:'..msg.chat_id_,msg.text)
...
print(" -- pinned -- ")
local msg_pin_id = redis:get(rambo..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and not msg.OurBot and redis:get(rambo..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(rambo..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(rambo..'group:name'..arg.chat_id_,arg.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(rambo..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(rambo..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(rambo..'welcome:get'..msg.chat_id_)
end
redis:setex(rambo..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if (msg.content_.ID == "MessageChatAddMembers") then
if redis:get(rambo..'welcome:get'..msg.chat_id_) then
if msg.adduserType then
welcome = (redis:get(rambo..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(rambo..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
local edited = (redis:get(rambo..':edited:'..msg.chat_id_..':'..msg.adduser) or 0)
local points = redis:get(rambo..':User_Points:'..msg.chat_id_..msg.adduser) or 0
local msgs = redis:get(rambo..'msgs:'..msg.adduser..':'..msg.chat_id_) or 1

if msg.adduser == SUDO_ID then 
gtupe = 'المطور الاساسي' 
elseif redis:sismember(rambo..':SUDO_BOT:',msg.adduser) then 
gtupe = 'المطور'
elseif msg.GroupActive and redis:sismember(rambo..':MONSHA_Group:'..msg.chat_id_,msg.adduser) then 
gtupe = 'منشئ اساسي'
elseif msg.GroupActive and redis:sismember(rambo..':MONSHA_BOT:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المنشىء'
elseif msg.GroupActive and redis:sismember(rambo..'owners:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المدير' 
elseif msg.GroupActive and redis:sismember(rambo..'admins:'..msg.chat_id_,msg.adduser) then 
gtupe = 'الادمن'
elseif msg.GroupActive and redis:sismember(rambo..'whitelist:'..msg.chat_id_,msg.adduser) then 
gtupe = 'عضو مميز'
...
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(rambo..'group:name'..msg.chat_id_) or '')))
...
local welcome = welcome:gsub("{البوت}",redis:get(rambo..':NameBot:'))
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(rambo..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(rambo..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين  👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
...
if msg.edited and not msg.SuperCreator and redis:get(rambo.."antiedit"..msg.chat_id_) then 
...
if #monsha ~= 0 then 
for k,v in pairs(monsha) do
local info = redis:hgetall(rambo..'username:'..v) if info and info.username and info.username:match("@[%a%d_]+") then usersmnc = usersmnc..info.username.." - " end
sendMsg(v,0,"📇¦ هناك شخص قام بالتعديل \n👲🏼¦ الاسم : ⋙「 "..NameUser.." 」 "..uuseri.."\n🀄️¦ الايدي : `"..msg.sender_user_id_.."`\n📬¦ رتبته : "..Getrtba(msg.sender_user_id_,msg.chat_id_).."\n🔌¦ نوع التعديل : "..Rwers.."\n📱¦ المجموعة : "..Flter_Markdown((redis:get(rambo..'group:name'..msg.chat_id_) or '')).."\n🔅¦ الرابط : "..redis:get(rambo..'linkGroup'..msg.chat_id_).." \n🚸" )
end
end
...
if not msg.forward_info_ and msg.content_.ID ~= "MessagePhoto" and redis:get(rambo..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(rambo..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(rambo..'num_msg_max'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then 
redis:setex(rambo..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',30,true)
...
redis:setex(rambo..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end


if msg.forward_info_ then
if redis:get(rambo..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(rambo..'lock_woring'..msg.chat_id_) and not redis:get(rambo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(rambo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(rambo..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and msg.content_.ID ~= "MessageText" and redis:get(rambo..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data) 
print("\27[1;31m Msg Del becuse send Edit \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*¦* لا يمكنني مسح الرساله المخالفه .\n🎟*¦* لست مشرف او ليس لدي صلاحيه  الحذف \n ❕')    
end
if redis:get(rambo..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
...
return false
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(rambo..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(rambo..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
or msg.text:match("[Ww][Ww][Ww].") 
or msg.text:match(".[Cc][Oo][Mm]")) 
and redis:get(rambo..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(rambo..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(rambo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("ه‍") or msg.text:match("ی") or msg.text:match("ک")) and redis:get(rambo.."lock_pharsi"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif KlmatMmno3(msg.text) and redis:get(rambo.."lock_mmno3"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("[a-zA-Z]") and redis:get(rambo.."lock_lang"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#.+") and redis:get(rambo..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(rambo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(rambo..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(rambo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(rambo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessagePhoto" then
if redis:get(rambo..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(rambo..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageVideo" then
if redis:get(rambo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(rambo..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageDocument" and redis:get(rambo..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageSticker" and redis:get(rambo..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAnimation" then
if redis:get(rambo..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(rambo..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageContact" and redis:get(rambo..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageLocation" and redis:get(rambo..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageVoice" and redis:get(rambo..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageGame" and redis:get(rambo..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAudio" and redis:get(rambo..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.reply_markup and  msg.reply_markup.ID == "replyMarkupInlineKeyboard" and redis:get(rambo..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(rambo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(rambo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(rambo.."lock_RandomRdod"..msg.chat_id_) then 
local Replay = 0
Replay = redis:smembers(rambo..':ReplayRandom:'..msg.text) 
if #Replay ~= 0 then 
...
Caption = redis:hget(rambo..':caption_replay:Random:'..msg.text,CaptionFilter)
...
local Replay = 0
Replay = redis:smembers(rambo..':ReplayRandom:'..msg.chat_id_..":"..msg.text) 
if #Replay ~= 0 then 
local Replay = Replay[math.random(#Replay)]
Replay = convert_Klmat(msg,data,Replay,true)
local CaptionFilter = Replay:gsub(":Text:",""):gsub(":Document:",""):gsub(":Voice:",""):gsub(":Photo:",""):gsub(":Animation:",""):gsub(":Audio:",""):gsub(":Sticker:",""):gsub(":Video:","")
Caption = redis:hget(rambo..':caption_replay:Random:'..msg.chat_id_..msg.text,CaptionFilter)
Caption = convert_Klmat(msg,data,Caption)
if Replay:match(":Text:") then
return sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay:gsub(":Text:","")))
elseif Replay:match(":Document:") then 
...
if redis:get(rambo..'replay'..msg.chat_id_) then
local Replay = false

Replay = redis:hget(rambo..'replay:all',msg.text)
if Replay then
Replay = convert_Klmat(msg,data,Replay,true)
...
Replay = redis:hget(rambo..'replay:'..msg.chat_id_,msg.text)
if Replay then 
Replay = convert_Klmat(msg,data,Replay,true)
sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay)) 
return false
...
Replay = redis:hget(rambo..'replay_photo:group:',msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
print(Caption)
...
Replay = redis:hget(rambo..'replay_voice:group:',msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(rambo..'replay_animation:group:',msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(rambo..'replay_audio:group:',msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(rambo..'replay_files:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(rambo..'replay_files:group:',msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendDocument(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(rambo..'replay_sticker:group:',msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(rambo..'replay_video:group:',msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(rambo..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendPhoto(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(rambo..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVoice(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(rambo..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAnimation(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(rambo..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAudio(msg.chat_id_,msg.id_,Replay,"",Caption)  
...
Replay = redis:hget(rambo..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(rambo..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(rambo..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVideo(msg.chat_id_,msg.id_,Replay,Caption)
...
if msg.text and redis:get(rambo.."lock_rdodSource"..msg.chat_id_) then
...
if redis:get(rambo..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(rambo..'ExpireDate:'..msg.chat_id_)
SUDO_USER = redis:hgetall(rambo..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
