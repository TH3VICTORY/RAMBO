...
if not redis:get(rambo..'group:add'..msg.chat_id_) then return '🛠*¦* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
local msgs = redis:get(rambo..'msgs:'..data.id_..':'..arg.chat_id_) or 1
if data.username_ then UserNameID = "🎫¦ مـعرفك •⊱ @"..data.username_.." ⊰•\n" else UserNameID = "" end
if data.username_ then UserNameRambo = '@'..data.username_ else UserNameRambo = 'لا يوجد' end
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
local Namei = FlterName(data,20)
local NumGhaRambo = (redis:get(rambo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local editedrambo = (redis:get(rambo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local gamesrambo = (redis:get(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0)
if not redis:get(rambo..':lock_id_photo:'..arg.chat_id_) then
IdRamboSaied = (redis:get(rambo..'idrambo:msg'..msg.chat_id_) or 
'👤¦ أســمـك •⊱ { '..Namei..' } ⊰•\n'
..'['..UserNameID..']'
..'🏷¦ ايديــك •⊱ {`'..data.id_..'`} ⊰•\n\n'
...
..'💬¦ رسائلك •⊱ {'..msgs..'} ⊰•\n➖')
local IdRamboSaied = IdRamboSaied:gsub("{الاسم}",Namei)
local IdRamboSaied = IdRamboSaied:gsub("{المعرف}",UserNameRambo)
IdRamboSaied = IdRamboSaied:gsub("{الايدي}",data.id_)
IdRamboSaied = IdRamboSaied:gsub("{الرتبه}",arg.TheRank)
IdRamboSaied = IdRamboSaied:gsub("{التفاعل}",Get_Ttl(msgs))
IdRamboSaied = IdRamboSaied:gsub("{الرسائل}",msgs)
IdRamboSaied = IdRamboSaied:gsub("{الجهات}",NumGhaRambo)
IdRamboSaied = IdRamboSaied:gsub("{السحكات}",editedrambo)
IdRamboSaied = IdRamboSaied:gsub("{النقاط}",gamesrambo)
sendMsg(arg.chat_id_,arg.id_,IdRamboSaied)
return false
end
...
..'💬¦ رسائلك •⊱ {'..arg.msgs..'} ⊰•\n'
..'🖲¦ نقاطك •⊱ {'..gamesrambo..'} ⊰•\n➖')
local IdRamboSaied = IdRamboSaied:gsub("{الاسم}",arg.Namei)
local IdRamboSaied = IdRamboSaied:gsub("{المعرف}",UserNameRambo)
IdRamboSaied = IdRamboSaied:gsub("{الايدي}",arg.sender_user_id_)
IdRamboSaied = IdRamboSaied:gsub("{الرتبه}",arg.TheRank)
IdRamboSaied = IdRamboSaied:gsub("{التفاعل}",Get_Ttl(arg.msgs))
IdRamboSaied = IdRamboSaied:gsub("{الرسائل}",arg.msgs)
IdRamboSaied = IdRamboSaied:gsub("{الجهات}",NumGhaRambo)
IdRamboSaied = IdRamboSaied:gsub("{السحكات}",editedrambo)
IdRamboSaied = IdRamboSaied:gsub("{النقاط}",gamesrambo)
sendPhoto(arg.chat_id_,arg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,IdRamboSaied,dl_cb,nil)
else
IdRamboSaied = (redis:get(rambo..'idrambo:msg'..msg.chat_id_) or 
...
end,{chat_id_=arg.chat_id_,id_=arg.id_,TheRank=arg.TheRank,sender_user_id_=data.id_,msgs=msgs,Namei=Namei,UserNameID=UserNameID,NumGhaRambo=NumGhaRambo,editedrambo=editedrambo})
end
...
if not data.id_ then return sendMsg(arg.ChatID,arg.MsgID,"📛*¦* لآ يوجد عضـو بهہ‌‏ذآ آلمـعرف \n❕") end 
local UserID = data.id_
local maseegs = redis:get(rambo..'msgs:'..UserID..':'..ChatID) or 1
...
if not msg.Creator then return "📛*¦*هذا الامر يخص {المطور,المنشئ} فقط  \n🚶‍♂️" end
local RamboChatIdG = MsgText[2]
GetFullChat(RamboChatIdG,function(arg,data)
if not data.member_count_ then return sendMsg(msg.chat_id_,arg.MsgID,"📛¦ فشل التحقق من المجموعة\n❕") end
local GroupName = (redis:get(rambo..'group:name'..arg.ChatID) or '')
local LinkGbRambo = data.invite_link_
if not LinkGbRambo then
local LinkGbRambo = ExportLink(RamboChatIdG)
if LinkGbRambo then
LinkGbRambo = LinkGbRambo.result
end
end
...
.."\n*🗣¦* عدد الادمـنـيـه •⊱ { *"..data.administrator_count_.."* } ⊰•"
.."\n*🔚¦* الايــدي •⊱ { `"..arg.ChatID.."` } ⊰•"
.."\n\nـ •⊱ {  ["..FlterName(GroupName).."]("..(LinkGbRambo or "")..")  } ⊰•\n"
)
end,{ChatID=RamboChatIdG,MsgID=msg.id_}) 
return false
end
end
...
USERNAME = USERNAME:gsub([[\_]],"_")
USERCAR = utf8.len(USERNAME) 
if not redis:sismember(rambo..'owners:'..arg.ChatID,arg.UserID) and not redis:sismember(rambo..'admins:'..arg.ChatID,arg.UserID) and not redis:sismember(rambo..'whitelist:'..arg.ChatID,arg.UserID) then
...
local Rambo_Text = Text:match("^كلهم (.*)$"),50
local t = "\n🗣¦ "..Rambo_Text.."\n━━━━━━━━━━━━━\n"
x = 0
local list = rambo.members_
for k, v in pairs(list) do
...
if not msg.Director then return "📛*¦*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:setex(rambo..'linkGroup'..msg.sender_user_id_,300,true)
return '📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الرابط الجديد 🍃'
end

if MsgText[1] == "ضع القوانين" then
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(rambo..'rulse:witting'..msg.sender_user_id_,300,true)
...
redis:set(rambo..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(rambo..'name:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(rambo..'about:witting'..msg.sender_user_id_,300,true) 
...
Getrtb = 'مطور اساسي ' 
elseif redis:sismember(rambo..':SUDO_BOT:',arg.UserID) then
Getrtb = 'مطور ' 
elseif redis:sismember(rambo..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
Getrtb = 'منشئ' 
elseif redis:sismember(rambo..'owners:'..arg.ChatID,arg.UserID) then
Getrtb = 'المدير ' 
elseif redis:sismember(rambo..'admins:'..arg.ChatID,arg.UserID) then
Getrtb = 'ادمن' 
elseif redis:sismember(rambo..'whitelist:'..arg.ChatID,arg.UserID) then
Getrtb = 'مميز' 
else
Getrtb = 'عضو' 
end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:set(rambo..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:set(rambo..'idrambo:edit'..msg.sender_user_id_,true) 
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(rambo..'idrambo:msg'..msg.chat_id_) then 
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد كليشه ايدي ليتم مسحه ✓" 
end
redis:del(rambo..'idrambo:msg'..msg.chat_id_)
...
if arg.pvC == arg.i then 
if NumPvDel == 0 then
PvRambo = '👨🏼‍⚕️| جـيـد , لا يوجد مشتركين وهمي\n\n'
else
local SenderOk = arg.pvC - NumPvDel
PvRambo = '👥*¦* عدد المشتركين •⊱ { *'..arg.pvC..'* } ⊰•\n♻️*¦* تـم تنظيف  •⊱ { *'..NumPvDel..'* } ⊰• مشترك \n📊*¦* اصبح العدد الحقيقي الان •⊱ { *'..SenderOk..'* } ⊰• من المشتركين\n\n'
end
end
end,{chat_id_=msg.chat_id_,id_=msg.id_,pvC=#pv,pv=pv[i],i=i})
end
...
local GroupDel = arg.groupsC - GroupsIsFound 
if GroupDel == 0 then
sendMsg(arg.chat_id_,arg.id_,PvRambo..'💯*¦* جـيـد , لا توجد مجموعات وهميه \n✓')
else
sendMsg(arg.chat_id_,arg.id_,PvRambo..'📑*¦* عدد المجموعات •⊱ { *'..arg.groupsC..'* } ⊰•\n🚸*¦* تـم تنظيف  •⊱ { *'..GroupDel..'* } ⊰• مجموعه \n📉*¦* اصبح العدد الحقيقي الان •⊱ { *'..GroupsIsFound..'* } ⊰• مجموعه\n✓')
end
end
end,{chat_id_=msg.chat_id_,id_=msg.id_,groupsC=#groups,group=groups[i],i=i})
end
...
if not redis:get(rambo..":TEXT_SUDO") then
return '⚙️¦ اوه 🙀 لا يوجد كليشه مطور اصلا ☹️\n🛠' end
redis:del(rambo..':TEXT_SUDO') 
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
local name_gp = redis:get(rambo..'group:name'..MsgText[2])
...
return send_msg(msg.chat_id_,redis:get(rambo..":TEXT_SUDO") or '🗃¦ لا توجد كليشه المطور .\n📰¦ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡',msg.id_)
end
...
redis:setex(rambo..'fwd:groupsrambo'..msg.sender_user_id_,300, true) 
...
redis:setex(rambo..'fwd:number'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(rambo..'welcom:witting'..msg.sender_user_id_,
rambo..'rulse:witting'..msg.sender_user_id_,
rambo..'rulse:witting'..msg.sender_user_id_,
rambo..'name:witting'..msg.sender_user_id_,
rambo..'about:witting'..msg.sender_user_id_,
rambo..'fwd:all'..msg.sender_user_id_,
rambo..'fwd:pv'..msg.sender_user_id_,
rambo..'fwd:groups'..msg.sender_user_id_,
rambo..'fwd:number'..msg.sender_user_id_,
rambo..'fwd:groupsrambo'..msg.sender_user_id_,
...
rambo..'CHENG:ID'..msg.chat_id_..msg.sender_user_id_)
...
return '👨🏾‍🔧¦ اصدار سورس كارمن : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™' or MsgText[1] == "/UpdateSource") then
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://raw.githubusercontent.com/TH3VICTORY/th3victory.github.io/master/GetVersion.txt') or 0
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس كارمن يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="كارمن : كارمن 🍃",url="t.me/rambo_syr"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : كارمن](t.me/rambo_syr)',nil,inline,msg.id_)
return false
end
...
redis:del(rambo..'replay:'..msg.chat_id_,
rambo..'replay_photo:group:'..msg.chat_id_,
rambo..'replay_voice:group:'..msg.chat_id_,
rambo..'replay_animation:group:'..msg.chat_id_,
rambo..'replay_audio:group:'..msg.chat_id_,
rambo..'replay_sticker:group:'..msg.chat_id_,
rambo..'replay_video:group:'..msg.chat_id_,
rambo..':caption_replay:'..msg.chat_id_)
...
if names or photo or voice or imation or audio or sticker or video then
redis:del(rambo..'replay:all',
rambo..'replay_photo:group:',
rambo..'replay_voice:group:',
rambo..'replay_animation:group:',
rambo..'replay_audio:group:',
rambo..'replay_sticker:group:',
rambo..'replay_video:group:',
rambo..':caption_replay_All:')
...
ISP=`curl https://faeder.net/error/ISP.php`
...
🧸🖤⁝ قائمهہ‏ الاوامر ‏الخاصة ~

🧸🍫⁝ م1 » آوآمـر آلآدآره ⛥
🧸🍫⁝ م2 » آوآمـر آعدآدآت آلمـجمـوعه ⛥
🧸🍫⁝م3 » آوآمـر آلحمـآيه ⛥
🧸🍫⁝ م المطور »  آوآمـر آلمـطـور ⛥
🧸🍫⁝ اوامر الرد » لآضـآفه رد مـعين ⛥
🧸🍫⁝ اوامر الملفات » لآدآره مــلفآت آلبوت ⛥
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(rambo..'lave_me'..msg.chat_id_) then 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(rambo..'lave_me'..msg.chat_id_) 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if redis:get(rambo..'lave_me'..msg.chat_id_) then 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(rambo..'lave_me'..msg.chat_id_,true)  
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/TH3VICTORY/th3victory.github.io/master/GetFiles.json")
if res == 200 then
...
if redis:get(rambo..'lock_service') then 
...
--====================== Reply Only Group =====================================
if msg.Admin and redis:get(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(rambo..'replay1'..msg.chat_id_..msg.sender_user_id_) then
...
redis:hset(rambo..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
...
--====================== Reply All Groups =====================================
if msg.SudoUser and redis:get(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(rambo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(rambo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.caption_ then redis:hset(rambo..':caption_replay_All:',klma,msg.content_.caption_) end
if msg.text then
...
redis:hset(rambo..'replay:all',klma,Flter_Markdown(msg.text))
...
if msg.SudoBase and redis:get(rambo..":ForceSub:"..msg.sender_user_id_) then
...
if msg.SudoBase and redis:get(rambo..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
...
if msg.SudoBase and redis:get(rambo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and not redis:get(rambo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
...
if msg.SudoUser and redis:get(rambo..'delrdall:'..msg.sender_user_id_) then
...
redis:hdel(rambo..'replay_sticker:group:',msg.text)
redis:hdel(rambo..'replay_video:group:',msg.text)
redis:hdel(rambo..':caption_replay_All:',msg.text)
...
if msg.SudoBase and redis:get(rambo..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
...
redis:set(rambo..':TEXT_SUDO',msg.text)
send_msg(msg.chat_id_, "📜*¦* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..msg.text.."  *}*\n✓",msg.id_)
end
return false
end

if msg.Admin and redis:get(rambo..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
if utf8.len(msg.text) > 2500 then 
sendMsg(msg.chat_id_,msg.id_,"📛¦ لا يمكنك وضع كليشه باكثر من 2500 حرف\n❕")
else
redis:del(rambo..'welcom:witting'..msg.sender_user_id_) 
...
if msg.Admin and redis:get(rambo..'idrambo:edit'..msg.sender_user_id_) then -- استقبال كليشه الايدي
if utf8.len(msg.text) > 1500 then 
sendMsg(msg.chat_id_,msg.id_,"📛¦ لا يمكنك وضع كليشه باكثر من 1500 حرف\n❕")
else
redis:del(rambo..'idrambo:edit'..msg.sender_user_id_) 
redis:set(rambo..'idrambo:msg'..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"📜*¦* تم وضع كليشه الايدي بنجاح  👋\n✓" )
end
return false
end

if msg.Admin and redis:get(rambo..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
if utf8.len(msg.text) > 2500 then 
sendMsg(msg.chat_id_,msg.id_,"📛¦ لا يمكنك وضع قوانين باكثر من 2500 حرف\n❕")
else
redis:del(rambo..'rulse:witting'..msg.sender_user_id_) 
...
if msg.Admin and redis:get(rambo..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
if utf8.len(msg.text) > 550 then 
sendMsg(msg.chat_id_,msg.id_,"📛¦ لا يمكنك اسم المجموعه باكثر من 550 حرف \n❕")
else
redis:del(rambo..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID="ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
return false
end

if msg.Admin and redis:get(rambo..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
if utf8.len(msg.text) > 1000 then 
sendMsg(msg.chat_id_,msg.id_,"📛¦ لا يمكنك وضع وصف باكثر من 1000 حرف \n❕")
else
redis:del(rambo..'about:witting'..msg.sender_user_id_) 
...
if redis:get(rambo..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(rambo..'linkGroup'..msg.sender_user_id_,link) 
redis:set(rambo..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
...
if msg.forward_info_ and redis:get(rambo..'fwd:groupsrambo'..msg.sender_user_id_) then
sendMsg(msg.chat_id_,msg.id_,'📑| اهلا عزيزي المطور \n🔖| جاري نشر التوجيه للمجموعات ...')			
redis:del(rambo..'fwd:groupsrambo'..msg.sender_user_id_)
local groups = redis:smembers(rambo..'group:ids')
...
return sendMsg(msg.chat_id_,msg.id_,'📜*¦* تم اذاعه التوجيه بنجاح 🏌🏻\n🗣*¦* للمـجمـوعآت » *'..#groups..'*\n✓')			
 ...
 if msg.forward_info_ and redis:get(rambo..'fwd:number'..msg.sender_user_id_) then
sendMsg(msg.chat_id_,msg.id_,'📑| اهلا عزيزي المطور \n🔖| جاري نشر التوجيه للمشتركين ...')   
redis:del(rambo..'fwd:number'..msg.sender_user_id_)
local pv = redis:smembers(rambo..'users')
local allpvfwd =  #pv
...
if msg.SudoBase and  msg.content_.ID == "MessagePhoto" and redis:get(rambo..'welcom_ph:witting'..msg.sender_user_id_) then
...
if msg.Admin and msg.content_.ID == "MessagePhoto" and redis:get(rambo..'photo:group'..msg.chat_id_..msg.sender_user_id_)then
...
if redis:get(rambo..'addrd:'..msg.chat_id_..msg.sender_user_id_) and not redis:get(rambo..'replay1'..msg.chat_id_..msg.sender_user_id_) then 
...
if redis:get(rambo..'delrd:'..msg.sender_user_id_) then  -- Del Replay For Group
...
redis:hdel(rambo..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..'replay_video:group:'..msg.chat_id_,msg.text)
redis:hdel(rambo..':caption_replay:'..msg.chat_id_,msg.text)
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(rambo..'welcome:msg'..arg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(rambo..'rulse:msg'..arg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(rambo..'group:name'..arg.chat_id_) or '')))
local welcome = welcome:gsub("{المعرف}",UserName)
...
redis:setex(rambo..':User_Fwd_Msg:'..arg.sender_user_id_..':flood',15,true)
...
if redis:get(rambo..'lock_woring'..arg.chat_id_) then
GetUserID(arg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(rambo..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(rambo..'replay'..msg.chat_id_) then
...
if msg.Admin and redis:get(rambo..'CheckExpire::'..msg.chat_id_) then
