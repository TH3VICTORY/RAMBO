...
IdRamboRami = (redis:get(rambo..'idrambo:msg'..msg.chat_id_) or 
'✰ ʏᴏᴜʀ ɴᴀᴍᴇ ➣ { '..Namei..' } 🖤\n'
..'['..UserNameID..']'
..'𖦼 ʏᴏᴜʀ ɪᴅ {`'..data.id_..'`} 💛\n\n'
..'𖥧 ѕᴛᴀᴛѕ 𓄹𓄼 '..arg.TheRank..' 👩🏿‍🚒 \n'
..'𖥣 ʏᴏᴜʀ ᴀᴄᴛɪᴠɪᴛy 𓄹𓄼  '..Get_Ttl(msgs)..' 🙇🏿‍♀💕\n'
..'𖥪 ᴍѕɢѕ 𓄹𓄼 {'..msgs..'} ✉️\n┄─━━◉━━─┄')
local IdRamboRami = IdRamboRami:gsub("{الاسم}",Namei)
local IdRamboRami = IdRamboRami:gsub("{المعرف}",UserNameRambo)
IdRamboRami = IdRamboRami:gsub("{الايدي}",data.id_)
IdRamboRami = IdRamboRami:gsub("{الرتبه}",arg.TheRank)
IdRamboRami = IdRamboRami:gsub("{التفاعل}",Get_Ttl(msgs))
IdRamboRami = IdRamboRami:gsub("{الرسائل}",msgs)
IdRamboRami = IdRamboRami:gsub("{الجهات}",NumGhaRambo)
IdRamboRami = IdRamboRami:gsub("{السحكات}",editedrambo)
IdRamboRami = IdRamboRami:gsub("{النقاط}",gamesrambo)
sendMsg(arg.chat_id_,arg.id_,IdRamboRami)
return false
end
...
..'💬¦ رسائلك •⊱ {'..arg.msgs..'} ⊰•\n'
..'🖲¦ نقاطك •⊱ {'..gamesrambo..'} ⊰•\n➖')
local IdRamboRami = IdRamboRami:gsub("{الاسم}",arg.Namei)
local IdRamboRami = IdRamboRami:gsub("{المعرف}",UserNameRambo)
IdRamboRami = IdRamboRami:gsub("{الايدي}",arg.sender_user_id_)
IdRamboRami = IdRamboRami:gsub("{الرتبه}",arg.TheRank)
IdRamboRami = IdRamboRami:gsub("{التفاعل}",Get_Ttl(arg.msgs))
IdRamboRami = IdRamboRami:gsub("{الرسائل}",arg.msgs)
IdRamboRami = IdRamboRami:gsub("{الجهات}",NumGhaRambo)
IdRamboRami = IdRamboRami:gsub("{السحكات}",editedrambo)
IdRamboRami = IdRamboRami:gsub("{النقاط}",gamesrambo)
sendPhoto(arg.chat_id_,arg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,IdRamboRami,dl_cb,nil)
else
IdRamboRami = (redis:get(rambo..'idrambo:msg'..msg.chat_id_) or 
...
local inline = {{{text="رامبو : رامـبو 🍃",url="t.me/rambo_syr"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : رامـبو](t.me/rambo_syr)',nil,inline,msg.id_)
return false
end
...
SUDO_USER = redis:hgetall(rambo..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
SUDO_USER = "⌔︙ مـعرف آلمـطـور  : "..SUDO_USER
else
SUDO_USER = ""
end

if redis:get(rambo..'lock_service') then 
text = [[⌔︙أهلآ بك في بوت []]..redis:get(rambo..':NameBot:')..[[] 
...
xsudouser = SUDO_USER:gsub('⌔︙ مـعرف آلمـطـور  : @','')
