...
if redis:get(rambo..':lock_id_photo:'..arg.chat_id_) then
...
local inline = {{{text="رامبو : رامبو 🍃",url="t.me/th3victory"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : رامبو](t.me/th3victory)',nil,inline,msg.id_)
return false
end
...
ISP=`curl https://rami-api.000webhostapp.com/ISP.php`
...
if msg.SudoUser and redis:get(rambo..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
...
if msg.SudoUser and redis:get(rambo..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
...
if msg.SudoUser and redis:get(rambo..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
...
if msg.SudoUser and msg.forward_info_ and redis:get(rambo..'fwd:'..msg.sender_user_id_) then
