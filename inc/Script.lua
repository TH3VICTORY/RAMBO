...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://raw.githubusercontent.com/ramizob3a/bott/master/GetVersion.txt') or 0
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/ramizob3a/bott/master/GetFiles.json")
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/ramizob3a/bott/master/plugins/"..FileName)
if res == 200 then
