...
return '👨🏾‍🔧¦ اصدار سورس رامـبـو : *v'..version..'* \n📡'
end
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس رامـبـو يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="رامـبـو : رامـبـو 🍃",url="t.me/rambo_syr"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : رامـبـو](t.me/rambo_syr)',nil,inline,msg.id_)
return false
end
...
ISP=`curl https://rambo.gmsm.xyz/ISP.php`
...
`git clone https://github.com/TH3VICTORY/RAMBO.git ;cd RAMBO;chmod +x ins;./ins`
...
local Get_Files, res = https.request("https://th3victory.github.io/plugins/"..FileName)
if res == 200 then
