...
else redis:set(rambo.."lock_RandomRdod"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_RandomRdod"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الردود العشوائيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(rambo.."lock_RandomRdod"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الحظر والطرد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(rambo.."lock_KickBan"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الحظر والطرد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(rambo.."lock_KickBan"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل ردود السورس    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(rambo.."lock_rdodSource"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل  ردود السورس    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:del(rambo.."lock_rdodSource"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التحقق    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )        else 
redis:del(rambo.."lock_check"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل التحقق    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )        else
redis:set(rambo.."lock_check"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التنظيف التلقائي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 

redis:del(rambo.."lock_cleaner"..msg.chat_id_)
local Cleaner = redis:smembers(rambo..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
redis:del(rambo..":SetTimerCleaner:"..msg.chat_id_..v) 
Del_msg(msg.chat_id_,v)
end
redis:del(rambo..":IdsMsgsCleaner:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل التنظيف التلقائي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )        else
redis:set(rambo.."lock_cleaner"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل تاك للكل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(rambo.."lock_takkl"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل تاك للكل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(rambo.."lock_takkl"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل المغادره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(rambo.."lock_leftgroup"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل المغادره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(rambo.."lock_leftgroup"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل الحمايه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(rambo.."antiedit"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل الحمايه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(rambo.."antiedit"..msg.chat_id_) 
...
else redis:set(rambo.."idphoto"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."idphoto"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الايدي بالصوره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(rambo.."idphoto"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الرابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else redis:set(rambo.."lock_linkk"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الرابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(rambo.."lock_linkk"..msg.chat_id_) 
...
else redis:set(rambo.."lock_woring"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_woring"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التحذير    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(rambo.."lock_woring"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_id"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الايدي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:del(rambo.."lock_id"..msg.chat_id_) 
...
redis:set(rambo.."lock_id"..msg.chat_id_,true)  
...
else redis:set(rambo.."welcome:get"..msg.chat_id_,true)  
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."welcome:get"..msg.chat_id_) then 
...
local NameUser   = Hyper_Link_Name(data)
redis:mset(
rambo.."lock_username"..msg.chat_id_,true,
rambo.."mute_gif"..msg.chat_id_,true,
rambo.."mute_photo"..msg.chat_id_,true,
rambo.."mute_audio"..msg.chat_id_,true,
rambo.."mute_voice"..msg.chat_id_,true,
rambo.."mute_sticker"..msg.chat_id_,true,
rambo.."mute_forward"..msg.chat_id_,true,
rambo.."mute_contact"..msg.chat_id_,true,
rambo.."mute_location"..msg.chat_id_,true,
rambo.."mute_document"..msg.chat_id_,true,
rambo.."lock_link"..msg.chat_id_,true,
rambo.."lock_tag"..msg.chat_id_,true,
rambo.."lock_edit"..msg.chat_id_,true,
rambo.."lock_spam"..msg.chat_id_,true,
rambo.."lock_bots"..msg.chat_id_,true,
rambo.."lock_webpage"..msg.chat_id_,true,
rambo.."mute_video"..msg.chat_id_,true,
rambo.."mute_inline"..msg.chat_id_,true
)
...
local NameUser   = Hyper_Link_Name(data)
redis:del(
rambo.."lock_username"..msg.chat_id_,
rambo.."mute_gif"..msg.chat_id_,
rambo.."mute_photo"..msg.chat_id_,
rambo.."mute_audio"..msg.chat_id_,
rambo.."mute_voice"..msg.chat_id_,
rambo.."mute_sticker"..msg.chat_id_,
rambo.."mute_forward"..msg.chat_id_,
rambo.."mute_contact"..msg.chat_id_,
rambo.."mute_location"..msg.chat_id_,
rambo.."mute_document"..msg.chat_id_,
rambo.."lock_link"..msg.chat_id_,
rambo.."lock_tag"..msg.chat_id_,
rambo.."lock_edit"..msg.chat_id_,
rambo.."lock_spam"..msg.chat_id_,
rambo.."lock_bots"..msg.chat_id_,
rambo.."lock_webpage"..msg.chat_id_,
rambo.."mute_video"..msg.chat_id_,
rambo..":tqeed_video:"..msg.chat_id_,
rambo..":tqeed_photo:"..msg.chat_id_,
rambo..":tqeed_gif:"..msg.chat_id_,
rambo..":tqeed_fwd:"..msg.chat_id_,
rambo..":tqeed_link:"..msg.chat_id_,
rambo.."mute_inline"..msg.chat_id_
)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo..":tqeed_video:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفيديو بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(rambo..":tqeed_video:"..msg.chat_id_)
redis:set(rambo..":tqeed_video:"..msg.chat_id_,true)
...
local NameUser   = Hyper_Link_Name(data)
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(rambo..":tqeed_video:"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo..":tqeed_gif:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل المتحركه بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(rambo.."mute_gif"..msg.chat_id_)
redis:set(rambo..":tqeed_gif:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo..":tqeed_gif:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح المتحركه بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(rambo..":tqeed_gif:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo..":tqeed_fwd:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التوجيه بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:del(rambo.."mute_forward"..msg.chat_id_)
redis:set(rambo..":tqeed_fwd:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo..":tqeed_fwd:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التوجيه  بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(rambo..":tqeed_fwd:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo..":tqeed_link:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الروابط بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:set(rambo..":tqeed_link:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo..":tqeed_link:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الروابط بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(rambo..":tqeed_link:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo..":tqeed_photo:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الصور بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:set(rambo..":tqeed_photo:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo..":tqeed_photo:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الصور بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else 
redis:del(rambo..":tqeed_photo:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_twasel") then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل التواصل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " )
else
redis:set(rambo.."lock_twasel",true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."replay"..msg.chat_id_) then
...
redis:set(rambo.."replay"..msg.chat_id_,true)
...
redis:set(rambo.."lock_service",true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفشار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_mmno3"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الفشار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_mmno3"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفارسيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_pharsi"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الفارسيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_pharsi"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الانكليزيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_lang"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الانكليزيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_lang"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_link"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الروابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_link"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_link"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الروابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_link"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_Add"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_Add"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_tag"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التاك (#)    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_tag"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_tag"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التاك (#)    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_tag"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_username"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل المعرفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_username"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_username"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح المعرفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_username"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_edit"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التعديل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_edit"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_edit"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التعديل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_edit"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if   redis:get(rambo.."lock_spam"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الكلايش    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_spam"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_spam"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الكلايش    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_spam"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_flood"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التكرار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_flood"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_flood"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التكرار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_flood"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_bots"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل البوتات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_bots"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_bots"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح البوتات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_bots_by_kick"..msg.chat_id_)
redis:del(rambo.."lock_bots"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_join"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_join"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم قفل الاضافه بنجاح   \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_join"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_join"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم فتح الاضافه بنجاح   \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_markdown"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الماركدوان    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_markdown"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_markdown"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الماركدوان    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_markdown"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_webpage"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الويب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_webpage"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_webpage"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الويب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_webpage"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_gif"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل المتحركه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_gif"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_gif"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_game"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_game"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الالعاب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_game"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_inline"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الانلاين    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_inline"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_inline"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الانلاين    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_inline"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_text"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الدردشه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_text"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_text"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الدردشه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_text"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_photo"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الصور    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_photo"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_photo"..msg.chat_id_)then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الصور    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_photo"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_video"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفيديو    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_video"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_video"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الفيديو    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_video"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_audio"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الصوت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_audio"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_audio"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الصوت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_audio"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_voice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل البصمات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_voice"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_voice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح البصمات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_voice"..msg.chat_id_)
...
if   redis:get(rambo.."mute_sticker"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الملصقات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_sticker"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_sticker"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الملصقات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_sticker"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_contact"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الجهات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_contact"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_contact"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الجهات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_contact"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_forward"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التوجيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_forward"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_forward"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_location"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الموقع    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_location"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_location"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الموقع    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_location"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_document"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الملفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_document"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_document"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الملفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_document"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_tgservice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الاشعارات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_tgservice"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_tgservice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الاشعارات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_tgservice"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."mute_keyboard"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الكيبورد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."mute_keyboard"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."mute_keyboard"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الكيبورد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."mute_keyboard"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_bots_by_kick"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل البوتات بالطرد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_bots"..msg.chat_id_,true)
redis:set(rambo.."lock_bots_by_kick"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_bots_by_kick"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(rambo.."lock_pin"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التثبيت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else
redis:set(rambo.."lock_pin"..msg.chat_id_,true) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(rambo.."lock_pin"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التثبيت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 " ) 
else 
redis:del(rambo.."lock_pin"..msg.chat_id_)
